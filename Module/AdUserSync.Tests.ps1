    ...
    describe 'Get-AdUserDefaultPassword' {
        ...
        it 'builds the default FilePath parameter correctly and passes it to Import-CliXml' {
            ...
            $assMParams = @{
                ...
                Scope = 'It'
                ParameterFilter = { 
                    $Path -eq 'C:\Users\martin.dome\CodigoSonarqube\Artifacts\DefaultUserPassword.xml' 
                }
            }
...
'@
        ...
        it 'builds the default FilePath parameter correctly and passes it to Import-Csv' {
            ...
            $assMParams = @{
                ...
                Scope = 'It'
                ParameterFilter = { 
                    $Path -eq 'C:\Users\martin.dome\CodigoSonarqube\Artifacts\Employees.csv' 
                }
            }
            Assert-MockCalled @assMParams
        }
    ...
    describe 'Get-InactiveEmployee' {
        ...
        it 'should only return AD users that are not in the CSV file' {
            ...
            Compare-Object $result.samAccountName @('inactive1','inactive2') | should benullorempty
